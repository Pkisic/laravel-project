    ...
    <div class="container">
        <div class="classy-nav-container breakpoint-off">
            <nav class="classy-navbar" id="bigshopNav">
                ...
                <!-- Nav Brand -->
                <a href="{{route('front.index.index')}}" class="nav-brand"><img src="{{url('/themes/front/img/core-img/logo.png')}}" alt="logo"></a>
                ...
                <div class="classy-menu">
                    ...
                    <div class="classynav">
                        <ul>
                            ...
                            <li><a href="{{route('front.pages.terms')}}">Terms And Conditions</a></li>
